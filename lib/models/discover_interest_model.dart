class DiscoverInterestModel {
  ...
  DiscoverInterestModel(  this.name,  this.tagLine,  this.image, this.location, this.images,
     this.description, this.price,this.rating);
}
List<DiscoverInterestModel> discoverModelList = discoverDataList
    .map((item) => DiscoverInterestModel( item['name'].toString(),item['tagLine'].toString(),
    item['image'].toString(),item['location'].toString(), item['images'] as List<String>, item['description'].toString(), item['price'].toString(),item["rating"] as double))
    .toList();

var discoverDataList = [
  {
    "name": "Matheran",
    "tagLine": "Pollution Free Hill Station in Maharashtra",
    "location":"46 Kms.2h 4m",
