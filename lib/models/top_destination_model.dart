class TopDestinationModel {
  ...
  TopDestinationModel(  this.name,  this.tagLine,  this.image, this.location, this.images,
     this.description, this.price,this.rating);
}
List<TopDestinationModel> topDestinationModelList = topDestinationDataList
    .map((item) => TopDestinationModel( item['name'].toString(),item['tagLine'].toString(),
...
var topDestinationDataList = [
  {
    "name": "South Island",
    "tagLine": "Semarang of Culture",
    "location":"Hayle, Cornwall",
    "image": "https://images.unsplash.com/photo-1510248703225-7f7838dfd579?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=687&q=80",
    "rating":2.1,
    "images": [
  ...
  },
  {
    ...
    "rating":4.1,
    "image":
    "https://images.unsplash.com/photo-1446483050676-bd2fdf3ac2d6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80",
    "images": [
  ...
  },
  {
    ...
    "location":"Hayle, Cornwall",
    "rating":4.1,
    "image": "https://images.unsplash.com/photo-1484402628941-0bb40fc029e7?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=687&q=80",
    "images": [
  ...
  },
  {
    ...
    "rating":5.0,
    "image":
    "https://images.unsplash.com/photo-1517021897933-0e0319cfbc28?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=786&q=80",
    "images": [
